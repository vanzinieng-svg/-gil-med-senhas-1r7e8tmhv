...
//   CHECK tickets_status_check: CHECK ((status = ANY (ARRAY['WAITING'::text, 'CALLED'::text, 'COMPLETED'::text, 'ABSENT'::text])))
//   CHECK tickets_type_check: CHECK ((type = ANY (ARRAY['NORMAL'::text, 'PREFERENCIAL'::text])))
